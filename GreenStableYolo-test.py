...
class NSGA2Optimizer:
    ...
    def createElem(self):
        param_ranges_dict = {
            "num_inference_steps": random.randint(15, 76),  # Number of denoising steps
            "guidance_scale": random.uniform(6, 14)
            * random.uniform(0, 1),  # Scale for classifier-free guidance
            "negative_prompt": random.randint(3, 6),
            "positive_prompt": random.randint(4, 9),
